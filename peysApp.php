...
<body>
        ...
        <form method="post">
            ...
            <input type="range" name="resize" id="resize" step=10 min=10 value=60>
            <br>
            ...
            <div class="wrapper" style ="max-width:
             30%;">
                <img src="/Activities/peysApp//mahbebe.jpg" style= "border: 3px solid <?php echo $borderColor; ?>;  width: <?php echo $photoSize;?>; ">
            </div>
        </form> 
</body>
</html>